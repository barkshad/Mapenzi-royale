    ...
    <div className="relative min-h-screen bg-royale-cream font-sans text-royale-brown selection:bg-royale-brown selection:text-white">
      ...
      <nav 
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 border-b ${
          isScrolled 
            ? 'bg-royale-cream/95 backdrop-blur-md border-royale-brown/10 py-3 md:py-4' 
            : 'bg-transparent border-transparent py-4 md:py-6'
        }`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          <a href="#" className="font-serif text-xl md:text-2xl tracking-widest font-bold text-royale-brown z-50">
            MAPENZI <span className="text-royale-gold">ROYALE</span>
          </a>
          
          <div className={`
            fixed inset-0 bg-royale-cream z-40 flex flex-col items-center justify-center gap-8 text-2xl font-serif tracking-widest transition-transform duration-500 md:static md:bg-transparent md:flex-row md:text-xs md:gap-8 md:translate-y-0 md:font-sans md:uppercase md:tracking-widest md:h-auto md:w-auto
          ...
          <div className="flex items-center gap-4 z-50">
            ...
            {/* Mobile Menu Toggle */}
            <button 
              className="md:hidden text-royale-brown p-2 -mr-2"
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-royale-brown text-white">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
          <div className="max-w-4xl mx-auto text-center space-y-6 md:space-y-8">
            <span className="inline-block text-royale-gold text-[10px] md:text-xs font-bold tracking-[0.2em] uppercase border border-royale-gold/30 px-3 py-1.5 md:px-4 md:py-2 rounded-full backdrop-blur-sm">
              Authentic Swahili Cuisine
            </span>
            
            <h1 className="font-serif text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-medium leading-[0.95] md:leading-[0.9] text-royale-cream">
              The Taste of <br/>
              <span className="italic text-royale-gold">Heritage.</span>
            </h1>
            
            <p className="font-sans text-base sm:text-lg md:text-xl text-white/80 font-light max-w-xl mx-auto leading-relaxed px-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8 w-full sm:w-auto px-6 sm:px-0">
              <Button href={callLink} variant="primary" icon={<Phone size={16} />} fullWidth className="sm:w-auto">
                Order Now
              </Button>
              <Button href={whatsappLink} variant="secondary" icon={<MessageCircle size={16} />} fullWidth className="sm:w-auto">
                WhatsApp
              </Button>
            </div>
          </div>
      ...
      <Section id="about" className="bg-royale-cream">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="order-2 md:order-1 relative">
            <div className="aspect-[4/5] bg-royale-brown/5 w-full overflow-hidden shadow-sm">
               <img 
            ...
            <div className="absolute -bottom-6 -right-6 w-24 h-24 md:w-32 md:h-32 bg-royale-gold/10 hidden lg:block -z-10"></div>
          </div>
          
          <div className="order-1 md:order-2 space-y-6 md:space-y-8">
            <div className="space-y-3 md:space-y-4">
              <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-royale-brown leading-tight">
                Tradition Served <br/>
            ...
            <div className="space-y-4 md:space-y-6 text-royale-brown/80 font-light text-base md:text-lg leading-relaxed">
              <p>
            ...
            <div className="grid grid-cols-2 gap-8 border-t border-royale-brown/10 pt-8">
              <div>
                <span className="block font-serif text-2xl md:text-3xl text-royale-brown">2026</span>
                <span className="text-[10px] md:text-xs uppercase tracking-widest text-royale-brown/60">Established</span>
              </div>
              <div>
                <span className="block font-serif text-2xl md:text-3xl text-royale-brown">Nakuru</span>
                <span className="text-[10px] md:text-xs uppercase tracking-widest text-royale-brown/60">Location</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <Section id="availability" className="bg-royale-brown text-royale-cream">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 md:mb-16 gap-6">
          <div className="space-y-2">
            ...
            <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl">When We Cook</h2>
          </div>
          <p className="text-white/60 text-sm max-w-xs text-left md:text-right font-light">
            We operate on a limited schedule to ensure maximum quality and freshness.
          </p>
        </div>

        <div className="grid grid-cols-7 gap-px bg-white/10 border border-white/10 overflow-hidden">
          {schedule.map((day) => (
            <div 
              key={day.day}
              className={`
                col-span-1 flex flex-col items-center justify-center py-6 md:py-12 transition-colors duration-300
                ${day.open ? 'bg-royale-gold text-royale-brown' : 'bg-transparent text-white/40'}
              `}
            >
              <span className="text-[10px] md:text-xs uppercase tracking-widest mb-1 md:mb-2 font-medium">{day.day}</span>
              <div className="h-1.5 w-1.5 md:h-2 md:w-2 rounded-full mb-1 md:mb-2">
                {day.open && <div className="w-full h-full bg-royale-brown animate-pulse rounded-full"></div>}
              </div>
              <span className={`text-[9px] md:text-[10px] uppercase tracking-wider ${day.open ? 'opacity-100 font-bold' : 'opacity-0'}`}>
                Open
              </span>
            </div>
          ))}
        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-between items-start sm:items-center text-xs text-white/50 tracking-wide border-t border-white/10 pt-4 gap-2">
      ...
      <Section id="menu" className="bg-royale-cream">
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-20 space-y-3 md:space-y-4">
          ...
          <h2 className="font-serif text-3xl md:text-5xl lg:text-6xl text-royale-brown">Curated Excellence</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          {menuItems.map((item) => (
            <div key={item.name} className="group flex flex-col h-full bg-white border border-royale-brown/5 hover:border-royale-gold/30 transition-colors duration-300">
              ...
              <div className="p-6 md:p-8 lg:p-10 flex flex-col flex-grow space-y-4">
                <div className="flex justify-between items-baseline border-b border-royale-brown/10 pb-4">
                  <h3 className="font-serif text-2xl md:text-3xl text-royale-brown">{item.name}</h3>
                  <span className="font-sans font-bold text-base md:text-lg text-royale-gold whitespace-nowrap ml-4">{item.price} KSH</span>
                </div>
                <p className="text-royale-brown/70 leading-relaxed font-light flex-grow text-sm md:text-base">
                  {item.description}
                </p>
                <div className="pt-4">
      ...
      {/* Footer / CTA */}
      <footer id="contact" className="bg-royale-brown text-white py-16 md:py-24 border-t border-white/5 mb-16 md:mb-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-24 items-start">
            <div className="space-y-6 md:space-y-8">
              <a href="#" className="inline-block font-serif text-2xl md:text-3xl tracking-widest font-bold">
                MAPENZI <span className="text-royale-gold">ROYALE</span>
              </a>
            ...
            <div className="bg-white/5 p-8 md:p-12 border border-white/10 space-y-6 md:space-y-8">
              <h3 className="font-serif text-2xl md:text-3xl">Reserve Your Plate</h3>
          ...
          <div className="mt-16 md:mt-20 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-white/40 uppercase tracking-widest text-center md:text-left">
      ...
      {/* Mobile Sticky Bar */}
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-white/90 backdrop-blur-lg border-t border-royale-brown/5 md:hidden z-50 flex gap-3 shadow-2xl">
         <Button href={callLink} variant="primary" fullWidth className="!py-3 shadow-md">
            Call
         </Button>
         <Button href={whatsappLink} variant="whatsapp" fullWidth className="!py-3 shadow-md" icon={<MessageCircle size={16}/>}>
            WhatsApp
         </Button>
      </div>
    </div>
